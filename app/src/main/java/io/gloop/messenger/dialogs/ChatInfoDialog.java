...
public class ChatInfoDialog {

    public ChatInfoDialog(final @NonNull Context context, final GloopUser owner, final Chat task, final UserInfo userInfo, final double x, final double y) {
